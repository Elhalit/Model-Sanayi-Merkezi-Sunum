...
export default function ProjectSection() {
  ...
  return (
    <section ref={sectionRef} className="section project-section bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" data-testid="project-section">
      <div className="w-full h-full px-4 py-4 overflow-y-auto">
        
        {/* Hero Section - Full Width with Images */}
        <div className="w-full mb-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-4 mb-6">
            {/* Left Image */}
            <div className="w-full lg:w-[35%] flex justify-center">
              <div className="w-full max-w-sm lg:max-w-none">
                <img 
                  ...
                  className="w-full h-auto rounded-xl shadow-2xl object-contain max-h-[300px] sm:max-h-[400px] lg:max-h-[500px]"
                />
              </div>
            </div>
            
            {/* Center Text */}
            <div className="w-full lg:flex-1 text-center px-2 lg:px-6 flex flex-col justify-center order-first lg:order-none">
              <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black leading-tight mb-4" style={{
          ...
          <div className="text-center mb-6">
            ...
            <div className="text-lg md:text-xl font-bold mb-4" style={{
              background: 'linear-gradient(to right, #ff5300, #ff6b1a, #ff5300)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text'
        ...
        <div className="w-full grid md:grid-cols-2 gap-6 mb-8">
          <div className="glass p-6 rounded-xl">
            <h2 className="text-2xl md:text-3xl font-black mb-3" style={{
              background: 'linear-gradient(to right, #ff5300, #ff6b1a, #ff5300)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text'
        ...
        {/* 76 Companies Section */}
        <div className="w-full mb-8">
          <div className="glass p-8 rounded-xl border border-orange-500/30 text-center project-feature opacity-0">
            <p className="text-5xl md:text-6xl lg:text-7xl font-black mb-3" style={{ 
              background: 'linear-gradient(to right, #ff5300, #ff6b1a, #ff5300)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text'
            ...
            <p className="text-sm md:text-base text-white/70 mb-6">Faaliyette</p>
        ...
        <div className="w-full glass p-8 rounded-2xl mb-12">
          ...
          <div className="flex justify-center space-x-12">
            <div className="text-center">
              <div className="text-4xl font-black text-white">9,50 m</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-black text-white">8,00 m</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-black text-white">12,00 m</div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="glass p-6 rounded-xl text-center">
              <div className="text-3xl font-black text-white mb-2">176</div>
