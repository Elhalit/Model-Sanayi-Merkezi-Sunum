  ...
  useEffect(() => {
    const loadFloorPlanData = async () => {
      try {
        ...
        let parsedUnits = parseCSV(unitsContent, '4');
              ...
              {selectedUnit ? (
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Firm Information */}
                    {(() => {
                      const firmInfo = getFirmInfoForUnit(firms, selectedUnit.block, selectedUnit.unitNumber, '4');
                      return firmInfo ? (
                  ...
                  return (
                    ...
                    >
                      <div className={`
                        ...
                        {getFirmInfoForUnit(firms, unit.block, unit.unitNumber, '4') && (
