...
export default function FloorPlansSection2() {
  ...
  useEffect(() => {
    const loadFloorPlanData = async () => {
      try {
        ...
        const parsedUnits = parseCSV(unitsContent, '2');
  ...
  return (
    <section className="section bg-gradient-to-br from-background via-muted to-background" data-testid="floorplans-section-2">
          ...
          <div className="w-full h-full p-8">
            <div className="w-full h-full relative">
              ...
              <div className="fixed top-1/2 left-4 transform -translate-y-1/2 glass p-4 rounded-lg space-y-6 z-50">
                {/* Info Panel */}
                <div>
                  <h3 className="font-semibold text-orange-500 mb-2">{activeBlock} Blok - 2. Etap</h3>
                ...
                {hoveredUnit ? (
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      {/* Firm Information */}
                      {(() => {
                        const firmInfo = getFirmInfoForUnit(firms, hoveredUnit.block, hoveredUnit.unitNumber, '2');
                        return firmInfo ? (
